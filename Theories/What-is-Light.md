...
Note: electrons absorb photons, and that causes a momentum-like force exerted on them as well, due to a change in energy, besides the standardly attributed EM-caused momentum (summarized [here](https://youtu.be/bvzr2HbbPC8?si=wyctUUwiOc5dQgfX)). This happens in projection screens, film, photodiodes, and proteins in the eyes that let us see called photopsins, but not in antennas. Antennas depend on a non-absorption based momentum from photons. Such momentum is typically attributed to EM forces (again, as summarized [here](https://youtu.be/bvzr2HbbPC8?si=wyctUUwiOc5dQgfX)). But if unpolarized light can exert momentum without being absorbed (no experiment has shown this, to my knowledge), then photons also carry an intrinsic momentum (e.g., a kind of collision force). I depict such a force with a kind of squeezed bell curve above, for [reasons described here](https://github.com/animal-tree/Writing-stuff-2/blob/main/Theories/Bendy-Ball.md).
