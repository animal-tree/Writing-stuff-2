...
>
> ### $``$ <sup>[^1]</sup>
> $\color{green}\mathrm{Note}\text{:}$ $\color{green}\mathrm{Einstein}$ $\color{green}\mathrm{made}$ $\color{green}\mathrm{a}$ $\color{green}\mathrm{rather}$ $\color{green}\mathrm{different}$ $\color{green}\mathrm{point}$ $\color{green}\mathrm{using}$ $\color{green}\mathrm{this}$ $\color{green}\mathrm{thought}$ $\color{green}\mathrm{experiment}\text{,}$ $\color{green}\mathrm{but}$ $\color{green}\mathrm{his}$ $\color{green}\mathrm{arguments}$ $\color{green}\mathrm{are}$ $\color{green}\mathrm{recycled}$ $\color{green}\mathrm{here}$ $\color{green}\mathrm{by}$ $\color{green}\mathrm{extrapolating}$ $\color{green}\mathrm{their}$ $\color{green}\mathrm{logic}$ $\color{green}\mathrm{equivalents}\text{.}$
