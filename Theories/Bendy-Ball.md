...
>
> <sub>$\text{\color{green}1.}$ He footnotes a proof to this statement on Page 126, via the compounding infinite lines of gravity that would accumulate at a point from their infinite origins in an infinite universe of uniformly-distributed mass density.</sub>
>
> ### $``$ <sup>[^1]</sup>
