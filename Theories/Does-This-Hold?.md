...
> "unecessarily long derivation that distracted me from transcribing my journal notes I wanted to transcribe" 
>
> [Actually no I'm making a new document for this. Hold up.]()

I didn't make that new document. And I just wrote an elaboration for why this proof doesn't hold and my browser tab suddenly closed, but not after that elaboration, after I specified that it was suspicious how my brain kept fixating back to this every time I went to try to transcribe my journal, which I wanted to do soon since the "ISCO" synchronicity I mentioned [here](https://github.com/animal-tree/Writing-stuff-2/blob/9628744752c8d18956f7a200296846f31e5445d0/Theories/I-Should-Research-This-More.md) is sort of time-dependent.

I just lost a lot of work because of a random tab-close. Essentially I went through the steps of the earlier disproof and compared them with this "Radius equation." The weird thing is, the browser didn't even ask about unsaved changes. The result was mentally bottlenecked, so I'm gonna re-write it below to try to conclude it and verify, but the conclusion was etching out to be that this disproof was false, perhaps due to the quadratic scaling of $n$.
...
As per "Coulomb's velocity equation" (Relationship 3). And that doesn't contradict Relationship 2 because that involves a quotient, not the energy-level $n$ by itself.

In short, just to not let that sycnhronicity go to waste, "ISCO" stands for "innermost stable circular orbit", which as I've shown above via Coulomb, is the fastest-velocity electron orbit. "ISCO" refers to a discovery that happened related to blackholes (not atoms) but with that analogous theme, and most notably, the video I linked about that discovery appeared and is time-stamped right after my GitHub commits about how and why the velocities of electrons in atoms might not be sufficient for photon emission even in Rutherford's considered-obsolete model, and that's what my un-transcribed journal notes (called "Atomic orbital theory") were about and describe a unified wave theory of light and general relativity.
