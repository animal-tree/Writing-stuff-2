...
Standardly, the energy-level is assumed to be the same as the wavelength-count integer ($n$ $=$ $\hat{n}$ is standardly assumed, although sometimes $n = 2\hat{n}$ is standardly assumed, without loss of generality).
