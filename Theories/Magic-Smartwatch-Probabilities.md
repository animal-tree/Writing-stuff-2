...
- The wristwatch just visually literalizes the math of that.
  ...
  - Alternatively, the whole wristwatch ($A$, $\frac{\partial \theta_\omega}{\partial t}$, and $\theta_\omega$) can be replaced with a simple harmonic oscillator ($\frac{\partial^2 A}{\partial t^2}$ $\propto$ $-f A$, where $A$ denotes the probability and polarity amplitudes), A.K.A. just your thumb curling in and out periodically.
