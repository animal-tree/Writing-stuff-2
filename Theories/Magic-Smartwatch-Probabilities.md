...
If you like, wristwatch probabilities can be thought of as a more physical, real spinnor. Spinnors 2.0. Spinnors as physical objects in space that vote amongst each other through orientation and location dependent interference. No imaginary units. Actual orientations and phases (which can be attributed angular momenta and precession) perpendicular to velocity.
