...
- However, with these non-wristwatch descriptions the polarity-dimension magnitude (which takes into account orientation in physical space) is no longer intrinsically tied to $\alpha$ the way it's expected to be in EM waves.
