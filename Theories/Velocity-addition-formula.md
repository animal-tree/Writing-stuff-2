...
Such applications of Einstein's theory can't be valid at the same time as Einstein's first postulate. The object in motion must be defined to travel at exactly the speed of light: $\frac{\partial x}{\partial t} = \frac{\partial x'}{\partial t'} = c$ by implication of Einstein's first postulate. Perhaps this holds, and the light beam is just bouncing around inside the medium at the required speed and only appears delayed, but it can't hold for an electron or other slower-than-light-speed masses/bodies. Einstein's first postulate is necessary to his derivation of the Lorentz transformation, and the latter is necessary to the derivation of the velocity-addition formula.
...
&#9432; **(1)** and **(2)** do not mean Einstein's first postulate or the Lorentz transformation are false. This pair of disproofs means that none of the experimental results of the velocity-addition formula can be attributed to the theory of Einstein's first postulate or vice versa (as it is standardly done, *e.g.*, the Fizeau experiment), and most or none of the experimental results of the theories of special and general relativity as a whole at below light speeds can be attributed to the theory of Einstein's first postulate or vice versa (as the ubiquitous consensus in physics does). It also raises the fundamental question, pertaining either to consciousness or intelligence, of how physicists didn't notice any of this, despite the core of the disproofs following immediately from elementary-level math. Additionally, it leaves Einstein's first postulate in a much more precarious position, only backed by such experiments as the Michelson–Morley experiment, which measure only the averaged bidirectional speed of light, not unidirectional.
