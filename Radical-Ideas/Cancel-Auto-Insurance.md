...
- That's still an improvement, since (with comprehensive, meaning including collision), Allstate wanted to charge me $1098.46 with automatic renewal (and they did 6 months previous to that without warning me, as I just re-verified to get the exact number on in my bank records). They randomly spiked up the price from about $800, which was the price I originally got with them.
