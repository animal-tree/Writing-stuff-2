...
- And Amica, which offered a lower quote, has a processing window that would’ve gone a few days over my current plan’s renewal/expiration date and only accepts covered customers. No grace period, requires missing the boat on avoiding some of Allstate's excess charges if not done more than two weeks in advance, which is ironic since their commercial is of them holding the subway door when it’s about to close.
