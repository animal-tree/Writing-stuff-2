...
Also, car insurance (at least private, perhaps even public) should pay for all car damages for people, including, e.g., dead batteries, since the purpose of car insurance is to insure cars (and probably medical damages from collisions, too, for that matter).
